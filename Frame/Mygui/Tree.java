...
public class Tree implements TreeWillExpandListener {
 
    private final FileSystemView fileSystemView;
 
    public Tree(FileSystemView fileSystemView){
    ...
    public void treeWillExpand(TreeExpansionEvent treeexpansionevent)
        ...
        final DefaultMutableTreeNode node =
                (DefaultMutableTreeNode) treeexpansionevent.getPath().getLastPathComponent();
